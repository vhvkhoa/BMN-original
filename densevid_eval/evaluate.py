...
class ANETcaptions(object):
    ...
    def import_prediction(self, prediction_filename):
        ...
        for vid_id in submission:
            results[vid_id] = submission[vid_id][:self.max_proposals]
        return results
...
def main(args):
    ...
    evaluator = ANETcaptions(ground_truth_filenames=args.references,
                             ...
                             detect_validate=args.detection_evaluation,
                             caption_validate=args.caption_evaluation)
    evaluator.evaluate()
...
if __name__ == '__main__':
    ...
    parser.add_argument('-c', '--caption-evaluation',
                        dest='caption_evaluation',
                        action='store_true',
